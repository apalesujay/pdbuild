app.service('MainService', function(AjaxService,AppConfig) {
    ...
    {
    var res= AjaxService.get(AppConfig.AppUrl+'eatery?filter={"establishment":"Street Food"}&fields=_id,name,locality,city,cuisine,dealAmount,dealConditions,imgMaster');
    return res;
};
